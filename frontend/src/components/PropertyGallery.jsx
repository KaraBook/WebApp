  ...
  return (
    <>
      <div className="relative flex gap-2 overflow-hidden">
        ...
        <img
          src={main}
          className="w-[48%] h-[400px] object-cover"
        />
        ...
        <div className="flex flex-col w-[25%] gap-2 relative">
          <img src={three} className="w-full h-[195px] object-cover" />
          <img src={four} className="w-full h-[195px] object-cover" />
          <button
            onClick={() => setShowModal(true)}
            className="absolute bottom-4 right-4 bg-white text-gray-800 font-medium 
                       px-4 py-2 shadow hover:bg-gray-100 transition"
          >
            Show all photos
          </button>
        </div>
